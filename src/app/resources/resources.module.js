...
var resources_routing_1 = require("./resources.routing");
...
ResourcesModule = __decorate([
    core_1.NgModule({
        imports: [common_1.CommonModule, resources_routing_1.resourcesRouting.routes, shared_module_1.SharedModule],
